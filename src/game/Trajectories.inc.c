...
const Trajectory KoopaBoB_path[] = {
	TRAJECTORY_POS(0,-3799,-627,-6226),
	TRAJECTORY_POS(1,-1040,-541,-6030),
	TRAJECTORY_POS(2,-617,-541,-5838),
	TRAJECTORY_POS(3,6468,-541,-5821),
	TRAJECTORY_POS(4,6683,-541,-5637),
	TRAJECTORY_POS(5,6658,774,-2412),
	TRAJECTORY_POS(6,6379,754,-1902),
	TRAJECTORY_POS(7,4447,750,1538),
	TRAJECTORY_POS(8,4466,750,1630),
	TRAJECTORY_POS(9,5107,750,2709),
	TRAJECTORY_POS(10,5334,755,3211),
	TRAJECTORY_POS(11,2778,122,5828),
	TRAJECTORY_POS(12,2135,122,5912),
	TRAJECTORY_POS(13,-2509,122,5726),
	TRAJECTORY_POS(14,-3275,122,5124),
	TRAJECTORY_POS(15,-3788,122,4109),
	TRAJECTORY_POS(16,-4000,122,-16),
	TRAJECTORY_END(),
};
const Trajectory KoopaTHI_path[] = {
	TRAJECTORY_POS(0,-1093,-1611,-3329),
	TRAJECTORY_POS(1,-2748,-1611,-2675),
	TRAJECTORY_POS(2,-4461,-1611,-2332),
	TRAJECTORY_POS(3,-4883,1478,719),
	TRAJECTORY_POS(4,-3244,1478,2661),
	TRAJECTORY_POS(5,-2392,1478,3488),
	TRAJECTORY_POS(6,3967,3547,3488),
	TRAJECTORY_POS(7,4522,3547,2947),
	TRAJECTORY_POS(8,4522,6643,-4611),
	TRAJECTORY_END(),
};
