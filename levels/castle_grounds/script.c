...
MACRO_OBJECT_WITH_BEH_PARAM(macro_wooden_signpost,93,5288,394,64736,50),
MACRO_OBJECT_WITH_BEH_PARAM(macro_wooden_signpost,32,1740,38,2500,65),
MACRO_OBJECT_WITH_BEH_PARAM(macro_wooden_signpost,0,63970,260,3503,167),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bobomb,29,60870,301,922,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_hidden_1up_in_pole,0,59266,975,63391,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,0,0,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,0,0,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,0,0,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_box_wing_cap,0,13,3476,59890,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_bobomb_buddy_opens_cannon_copy,0,59153,543,61269,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_box_metal_cap,0,0,1219,61962,1),
MACRO_OBJECT_WITH_BEH_PARAM(macro_floor_switch_hidden_objects,0,62157,64892,63511,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,0,0,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_breakable_box_no_coins,0,0,0,0,0),
MACRO_OBJECT_WITH_BEH_PARAM(macro_cannon_closed,0,2384,70,1982,0),
...
WARP_NODE(5,26,1,2,0),
WARP_NODE(4,26,1,1,0),
...
OBJECT_WITH_ACTS(212,4702,-1187,3776,0,0,0,0x0, bhv1Up,31),
OBJECT_WITH_ACTS(217,1,775,-3210,0,0,0,0x0, bhvPushableMetalBox,31),
...
OBJECT_WITH_ACTS(212,40,7627,-4023,0,0,0,0x0, bhv1Up,31),
OBJECT_WITH_ACTS(212,3925,2339,-6573,0,0,0,0x0, bhv1Up,31),
OBJECT_WITH_ACTS(212,-3991,2339,-6491,0,0,0,0x0, bhv1Up,31),
OBJECT_WITH_ACTS(22,-1137,3174,-3798,0,0,0,0x50000, bhvWarpPipe,31),
...
OBJECT_WITH_ACTS(0,-3379,-815,-2025,0,0,0,0x14050000, bhvWarp,31),
