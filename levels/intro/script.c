...
const LevelScript level_intro_splash_screen[] = {
    ...
    CLEAR_LEVEL(),
    SLEEP(/*frames*/ 2),
    EXIT_AND_EXECUTE(/*seg*/ 0x14, _introSegmentRomStart, _introSegmentRomEnd, script_intro_L1), // SUNLITNOTE: change to script_intro_l1 to skip, level_intro_mario_head_regular to keep head
};
